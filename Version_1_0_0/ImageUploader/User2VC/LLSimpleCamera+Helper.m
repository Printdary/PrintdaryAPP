...
//if let response = String(bytes: strData, encoding: .utf16) {
//    var strArry = response.components(separatedBy: "/")
//    print("strArry count = \(strArry.count)")
//    if strArry.count > 34  && strArry.count < 36{
//        strArry.remove(at: 0);
//        homVC.drow(strArry)
//    }
//}
