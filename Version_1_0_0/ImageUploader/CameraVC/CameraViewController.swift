...
class CameraViewController: UIViewController ,AVCapturePhotoCaptureDelegate,TOCropViewControllerDelegate{
...
//        present(cropViewController, animated: true, completion: nil)
        ...
        let cvc = storyboard.instantiateViewController(withIdentifier: "cropVC")
