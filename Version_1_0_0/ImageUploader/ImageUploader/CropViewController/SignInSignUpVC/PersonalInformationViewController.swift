...
class PersonalInformationViewController: UIViewController,UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    override func viewDidLoad() {
        ...
        if UserModel.currentUser.name != "" {
        helloLabel.text = "Hello \(UserModel.currentUser.name)!"
        }
   ...
   override  func viewWillAppear(_ animated: Bool) {
    ...
    func getCountres(){
        ...
        var sortedArray = countries.sorted { $0.localizedCaseInsensitiveCompare($1) == .orderedAscending }
        countries.removeAll()
                        ...
                        if error != nil {
                            ...
                            accountDataRef.updateChildValues(accountDict){
                                ...
                                if error != nil{
                                    ...
                                    NotificationCenter.default.post(name: Notification.Name.init("DID_LOGIN"), object: nil)
                                }
                            }
                        }
                    }
